...
int main(int argc, char* argv[]) {
      if (argc == 1){ //open up gui
        ...
        if (argc != 4 && argc != 5){
            ...
            cout<<"parserLanguage can be any of the following: cpp, python.\n"<< endl;
        ...
        vector<string>validLangs = {"cpp", "python"};
        ...
        if (!valid){
            ...
            cout<<"This argument must be one of the following: cpp, python."<<endl;
            return 1;
        }
        ...
        FileWriter fileWriter(oLanguage);

        fileWriter.fileSetup(tokeniser.getAllFirstSetInfo(), tokeniser.getListOfTokens(), tokeniser.getTokenRegexes(), "");
